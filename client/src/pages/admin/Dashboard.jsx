    ...
    <>
      ...
      <div className='relative flex flex-wrap gap-4 mt-6'>
        ...
        <div className='flex flex-wrap gap-4 w-full'>
          {dashboardCards.map((card,index)=>(
            <div key={index} className='flex items-center justify-between px-4 py-3 bg-[var(--color-primary)]/10 border border-[var(--color-primary)]/20 rounded-md max-w-50 w-full'>
              <div>
      ...
      <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
        ...
        {dashboard.activeShows.map((show) => (
          <div key={show._id} className='w-55 rounded-lg overflow-hidden h-full pb-3 bg-[var(--color-primary)]/20 hover:-translate-y-1 transition duration-300'>
